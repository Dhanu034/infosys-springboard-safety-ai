...
export default function Header({ selectedProject, setSelectedProject, projects, hazardsCount, onRefresh }) {
  return (
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="hidden lg:flex items-center gap-3 bg-slate-900/80 px-3.5 py-1.5 rounded-lg border border-slate-800 text-xs">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-slate-200">Site Risk Agent Active</span>
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button className="p-2 rounded-lg bg-slate-900 border border-slate-800 text-slate-300 hover:text-amber-400 transition-colors flex items-center justify-center">
